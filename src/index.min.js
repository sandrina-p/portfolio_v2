...
var ChatApp = function () {
    ...
    function clickOption($option) {
        ...
        untilTablet = window.innerWidth < 750, section = $option.closest('.chatSection').attr('id'), $currentPart = $option.closest('.chatPart'), btnName = $option.text(), title = $option.attr('name'), id = Util.stringSlugLower(title);
