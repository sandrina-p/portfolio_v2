...
var ChatApp = function () {
    ...
    function getElPart() {
        return $('<div class="chatPart" id="' + id + '">' + getElTitle(title) + getElSentence(text) + '</div>');
    }
    ...
    function getElSentence(text) {
        return '<div class="chatPart-bot">' + ('<p class="chatPart-text jsLoading" role="alert" aria-atomic="true">' + text + '</p>')
        // options
        + '</div>';
    }
    ...
    function buildSection($chatSection) {
        ...
        $('<section/>', {
            ...
            'html': '<div class="chatPart" id="' + section + '-intro">' + getElTitle(title) + getElSentence(text) + '</div>'
        }).appendTo($chatId);
