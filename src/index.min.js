...
var ChatApp = function () {
    ...
    function getElPart() {
        return $('<div class="chatPart" id="' + id + '" aria-live="polite">' + '<div class="chatPart-human">' + ('<h3 class="chatPart-title jsLoading">' + title + '</h3>') + '</div>' + '<div class="chatPart-bot">' + ('<p class="chatPart-text jsLoading">' + text + '</p>')
        // options
        + '</div>' + '</div>');
    }
    ...
    function buildSection($chatSection) {
        ...
        var $section = $('<section class="chatSection jsLoading" id="' + section + '">' + '<div class="chatPart" id="' + section + '-intro" aria-live="polite">' + '<div class="chatPart-human">' + '<h2 class="chatPart-title jsLoading">' + title + '</h3>' + '</div>' + '</div>' + '</section>'),
            ElChatPart;
