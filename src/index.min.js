...
var Projects = function () {
    ...
    function buildProj() {
        ...
        return $('<div class="proj" id="projects">' + '<div class="bot-nav"></div>' + '<div class="projNav">' + '<div class="projNav-pivot">' + ('<div class="projNav-left">' + elNav + '</div>') + ('<div class="projNav-right">' + elNav + '</div>') + '</div>' + '</div>' + '<div class="projCont">' + '<div class="projCont-left">' + '<div class="projCont-media">' + '<div class="Glidder"> </div>' + '</div>' + '</div>' + '<div class="projCont-right">' + '<div class="projCont-links"></div>' + '<div class="projCont-descript">' + '<p class="projCont-intro"> </p>' + '<p class="projCont-details"> </p>' + '</div>' + '<div class="projCont-about">' + '<p class="projCont-role"> </p>' + '<p class="projCont-date"> </p>' + '<p class="projCont-team"> </p>' + '</div>' + '</div>' + '</div>' + '</div>');
    }
    ...
    function addProjNav(numberOfProj) {
        ...
        if (isParentLeft) {
            ...
            for (var _i2 = 0; _i2 < numberOfProj; _i2++) {
                if (arrProjects[projI]) {
                    projName = arrProjects[projI];
                } else {
                    projI = 0;
    ...
    function getProjDomElements() {
        ...
        $projMedia = $(classProjMedia), $projTeam = $(classProjTeam), $projRole = $(classProjRole), $projIntro = $(classProjIntro), $projDetails = $(classProjDetails), $projLinks = $(classProjLinks), $projBotTip = $(classProjBotTip), $pivot = $(classPivot), $projsLeft = $(classProjLeft), $projsRight = $(classProjRight);
    }
    ...
    function getProjectImgs(imgArray) {
        ...
        function fetchRes(res) {
            if (res) {
                for (var _i3 = 0, arr = imgArray.length; _i3 < arr; _i3++) {
                    imgRet = imgArray[_i3].split('.');
            ...
            for (var _i4 = 0, _arr = imgArray.length; _i4 < _arr; _i4++) {
                elImgs += '<img src=\'' + imgArray[_i4] + '\'>';
            }
    ...
    function changeBotNavText(text) {
        ...
        setTimeout(function () {
            return $projBotTip.html(text);
        }, 150);
        setTimeout(function () {
            return $projBotTip.removeClass('.jsLoading');
        }, 300);
    }
