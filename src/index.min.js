...
var ChatApp = function () {
    ...
    function buildSection($chatSection) {
        ...
        var $section = $('<section class="chatSection" id="' + section + '">' + '<div class="chatPart" id="' + section + '-intro" aria-live="polite">' + '<div class="chatPart-human">' + '<h2 class="chatPart-title">' + title + '</h3>' + '</div>' + '</div>' + '</section>'),
            ElChatPart;
