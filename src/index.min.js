...
var ChatApp = function () {
    ...
    function getElPart() {
        return $('<div class="chatPart" id="' + id + '">' + '<div class="chatPart-human">' + ('<h3 class="chatPart-title jsLoading">' + title + '</h3>') + '</div>' + '<div class="chatPart-bot">' + ('<p class="chatPart-text jsLoading">' + text + '</p>')
        // options
        + '</div>' + '</div>');
    }
