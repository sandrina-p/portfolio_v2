...
var Projects = function () {
    ...
    function buildProj() {
        ...
        return $('<div class="proj" id="projects">' + '<div class="bot-nav"></div>' + '<div class="projNav">' + '<div class="projNav-pivot">' + '<nav class="projNav-left" aria-labelledby="a11y-projNav">'
        // W3C will not say "Untitled Nav" and at the same time Screen Readers will read correctly Nav without reading the h4 ;)
        + '<h4 id="a11y-projNav" class="sr-only" aria-hidden="true">Projects in a carousel</h4>' + elNav + '</nav>' + ('<div class="projNav-right" aria-hidden="true">' + elNav + '</div>') + '</div>' + '</div>' + '<article id="a11y-projCont" class="projCont">' + '<h4 class="sr-only js-projCont-title"> </h4>' + '<div class="projCont-left">' + '<div class="projCont-media">' + '<div class="Glidder"> </div>' + '</div>' + '</div>' + '<div class="projCont-right">' + '<div class="projCont-links"></div>' + '<div class="projCont-descript">' + '<h5 class="projCont-intro"> </h5>' + '<p class="projCont-details"> </p>' + '</div>' + '<div class="projCont-about">' + '<p class="projCont-role"> </p>' + '<p class="projCont-date"> </p>' + '<p class="projCont-team"> </p>' + '</div>' + '</div>' + '</div>' + '</div>');
    }
