...
var ChatApp = function () {
    ...
    function clickOption($option) {
        ...
        untilTablet = window.innerWidth < 750, section = $option.closest('.chatSection').attr('id'), $currentPart = $option.closest('.chatPart'), btnName = $option.text(), title = $option.attr('name'), id = UtilFuncs.stringSlugLower(title);
    ...
    function buildSection($chatSection) {
        ...
        ElChatPart = $('<div class="chatPart-bot">' + ('<p class="chatPart-text jsLoading">"' + text + '</p>') + '</div>');
