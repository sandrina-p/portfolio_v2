...
var Swipper = function () {
    ...
    var SWIPE_MIN = 40; // min px needed to trigger swipe
    var SWIPE_OPPOSITE_MAX = 75; // max px on opposite direction to prevent swipe
    var touchstartX = 0;
    var touchstartY = 0;
    var touchendX = 0;
    var touchendY = 0;
    ...
    function handleSwipe(direction, callback, args) {
        ...
        var scrolledTop = scrollEndTop + touchendY - (scrollStartTop + touchstartY);
        var scrolledLeft = scrollEndLeft + touchendX - (scrollStartLeft + touchstartX);
