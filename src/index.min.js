...
var ChatApp = function () {
    ...
    function clickOption($option) {
        ...
        wHeight = window.innerHeight, untilTablet = window.innerWidth < 750, section = $option.closest('.chatSection').attr('id'), $currentPart = $option.closest('.chatPart'), btnName = $option.text(), title = $option.attr('name'), id = UtilFuncs.stringSlugLower(title);
    ...
    function buildSection($chatSection) {
        console.log('ora bem');
        title = $chatSection.attr('data-section'), section = $chatSection.attr('data-section');

        var $section = $('<div class="chatSection" id="' + section + '">' + '<div class="chatPart" id="' + section + '-intro">' + '<div class="chatPart-human">' + '<h3 class="chatPart-title">' + section + '</h3>' + '</div>' + '</div>' + '</div>'),
            ElChatPart;
