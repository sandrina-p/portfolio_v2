...
var TalkChat = function () {
    ...
    var conversation = {
        ...
        behaviour: {
            ...
            psstMob: ["Hmm...", "You really like to scroll <span class='nowrap'>don't you?</span>", "", "not really"]
        }
    };
...
var TalkBot = function () {
    ...
    var publicCmd = "Some stuff you can know about:" + brk + "<b>best practices</<b>" + brk + "<b>challenges</<b>" + brk + "<b>resources</<b>" + brk + "<b>exit</<b>" + brk + "<b>...</b>" + brk + "<i>and much more but I'll not tell you.</<i>";

    var botTextAbout = brk + "I was born inside the Atom editor." + brk + "^100 HTML5, SCSS and Javascript are my vital organs." + brk + "^500 Eventually I evolved and started being built with " + linkKoala + " but as any good programmer knows, crashes happen, so " + linkGulp + " took its place!" + brk + "^250 Despite always being under construction I already have the ability to share some stuff that Sandrina taught me while I was growing up." + brk + "" + publicCmd;
    ...
    var conversation = {
        ...
        options: {
            ...
            */
            "infinity, infinito, ∞, universe, cosmos": ["You are a little crazy… we all are." + brk + "^1000" + botTextAbout, "commands", "what's next?", "typedJS"],
...
var Projects = function () {
    ...
    function alignPivot($newProject) {
        ...
        $newProject = $newProject || $projActive, pivotX = $pivot.offset().left, projActiveX = $newProject.offset().left;
