...
var chatApp = function () {
    ...
    mediaQHeight = 550,
        // a trigger to prevent some stuff on small devices
    wHeight = window.innerHeight,
        // doesn't need expl., does it?
    navSectionTop,
        //number - nav offsetTop to trigger fixed class
    ...
    function init(option) {
        section = option.closest('.chatSection').attr('id'), $currentPart = option.closest('.chatPart'), title = option.text(), id = title.slugLower();
    ...
    function getElBtn(text) {
        return "<div class='chatPart-option jsLoading'>" + "<button type='button' name='button' class='btnB jsLoading js-chatOpt'>" + text + "</button>" + "</div>";
    }
    ...
    function scrollSafe($currentPart) {
        var wScroll = $(window).scrollTop(),
            wHeight = window.innerHeight,
            //NOTE: i need to set this var again because strange bug on iphone that doesn't get the real value.
    ...
    function navTranslate(thisId) {
        var navWidth = genericVal.untilTablet ? 0 : 16,
            //padding
        thisId = thisId || null;
