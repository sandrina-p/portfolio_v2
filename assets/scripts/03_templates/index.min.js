...
var TalkChat = function () {
    ...
    var conversation = {
        ...
        behaviour: {
            ...
            psstChat: ["i'm surprised", "Hmm... I'm not allowed to share more info about her." + brk + "But by all means, don't be shy and go <a href='mailto:a.sandrina.p@gmail.com?subject=Hello!' target='_blank' class='link'>say hello</a>." + brk + "She is very nice, specially if you are a good looking website like me.", "Who are you?"],
...
var TalkBot = function () {
    ...
    var publicCmd = "What do you want to know?" + brk + "<b>technologies</b>" + brk + "<b>best practices</<b>" + brk + "<b>challenges</b>" + brk + "<b>resources</b>" + brk + "<b>exit</b>" + brk + "<b>...</b>";

    var botOptHelp = "Maybe you should " + googleIt + " and then come back. What do you think?";

    var conversation = {
        // intro: ['type gg', "aqui", "options"],
        intro: ["Now that we talked enough about Sandrina," + brk + "^100Ah yes, that's her name, I forgot to tell you." + brk + "^150 Now we can talk about me. Like, nerd talk... but before that just tell me one thing:" + brk + "1 divided by 0 equal to:", "your answer here", "options"],
        options: {
            /* STRUCTURE:
            ...
            */
            ...
            "∞ infinity, infinity, ∞, universe, cosmos": ["You are a little crazy… we all are." + brk + "Despite always being under construction I already have the ability to share some knowledge Sandrina taught me while I was growing up." + publicCmd, "what's next?", "commands"],
        ...
        commands: {
            ...
            "resources": [["still under construction. But ${linkCHTSTW}. I think he is in the family.", "come back soon and I'll have more stuff to share", "commands"]],
        ...
        vocabulary: {
            ...
            "bye, cya, shut down, exit, halt, close": ["You know what... It's really hard having a human conversation." + brk + "That's why I'm just a website." + brk + "<i>008080</i> by the way, that's how they call me." + brk + "Nice to meet you :) It was good to talk to you, thank you!" + brk + "But now do me a favor and go get a life, yes?" + brk + "It’s not healthy to talk to a bot all day." + brk + "By the way, don't forget to share me and talk about Sandrina while you’re out there :3", "press ESC to close"],
