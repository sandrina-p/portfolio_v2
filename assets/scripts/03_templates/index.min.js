...
var TalkChat = function () {
    ...
    var conversation = {
        ...
        behaviour: {
            ...
            psstChat: ["i'm surprised", "i'm not sure what to say but ... algo fun <span class='nowrap'>seria nice.</span>", "[go to bot]"],
...
var TalkBot = function () {
    ...
    var conversation = {
        ...
        options: {
            ...
            */
            "∞ infinity, infinity, , ∞, universe, cosmos": ["You are a little crazy… we all are." + brk + "Despite always being under construction I already have the ability to share some stuff that Sandrina taught me while I was growing up. " + publicCmd, "what's next?", "commands"],
            "infinito, infinite": ["I think you meant <b>infinity</b> right?", "", "options"],
            ...
            "welcome back": ["Look who is back! So, How much is 1/0?", "options"]
        },
        ...
        vocabulary: {
            ...
            "tilttt": ["ahhh... Something went wrong and I almost crashed... please can you try again?", "sandrina will take a look. I hope."],
...
var TalkBotVocabulary = function (currentTalkBot) {
    ...
    */
    ...
    knowIt["birthday, when's your birthday, your birthday, when is your birthday, birth date, your birth date"] = ["I was created somewhere between July and October 2016, and oficially released on November 2016"];
...
var Projects = function () {
    ...
    windowBotWidth = window.innerWidth * 40 / 100,
        numbOfGestures = 0;
    projectsVisible = false, gael = ""; //google analytics order of projects viewed
    ...
    function addProjNav(quantity) {
        var addProjects = "",
            nameSlug,
            projI = isParentLeft ? arrProjects.indexOf($projsLeft.children(":first").text()) : arrProjects.indexOf($projsRight.children(":last").text());

        if (isParentLeft) {

            for (var i = 1, projRestart = arrProjects[arrProjects.length - 1]; i <= quantity; i++) {
                projName = arrProjects[projI - i] || projRestart;
                nameSlug = UtilFuncs.stringSlugLower(projName), addProjects += getElBtn(nameSlug, projName);
            }
        } else {
            for (var i = 1, projRestart = arrProjects[arrProjects.length - 1]; i <= quantity; i++) {
                projName = arrProjects[projI + i] || projRestart;
...
var Psst = function () {
    ...
    $(document).on('click', '.js-botProjects', function () {
        ...
        if (hasTouch) {
            ...
            var wScroll = $(window).scrollTop(),
                wHeight = window.innerHeight;
            pHeight = $("#btn-pr").height(), pScroll = $("#btn-pr").offset().top, tooClose = pScroll - wScroll + pHeight > wHeight / 2;
