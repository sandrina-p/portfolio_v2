...
linkKoala = genLink('//koala-app.com/', 'Koala'), linkGulp = genLink('http://gulpjs.com/', 'Gulp'), linkSUIT = genLink('#linkTODO', 'SUIT methodology'), linkMP = genLink('#TlinkODO', 'Module Pattern'), linkLT = genLink('#TlinkODO', 'perceived loading time'), linkFOUC = genLink('#linkTODO', 'FOUC'), linkGit = genLink('#linkTODO', 'Bitbucket'), linkHer = genLink('http://www.imdb.com/title/tt1798709/', "Her"), myEmail = genLink('mailto:a.sandrina.p@gmail.com?subject=Hey%20there!', 'a.sandrina.p@gmail.com', "noTarget");
...
var Projects = function () {
    ...
    $projSub,
        ...
        $projLinks,
        $projBotTip,
        // getProjPlaceholders variables
    $newActive,
        fPos,
        $projDir,
        addProjNumb,
        isParentLeft,
        //arrowsNavProj variables
    estimateFinalWidth,
        projActiveWidth,
        pivotPos,
        projActivePos,
    ...
    function buildProj() {
        ...
        $ElProj = $("<div class='proj' id='projects'>" + "<div class='bot-nav'></div>" + "<div class='projNav'>" + "<div class='projNav-pivot'>" + "<div class='projNav-left'>" + elProjNav + "</div>" + "<div class='projNav-right'>" + elProjNav + "</div>" + "</div>" + "</div>" + "<div class='projCont'>" + "<div class='projCont-left'>" + "<p class='projCont-subtitle'>" + sub + "</p>" + "<div class='projCont-media'>" + "<div class='Glidder'>" + elImgs + "</div>" + "</div>" + "<div class='projCont-about'>" + "<p class='projCont-role'>" + role + "</p>" + "<p class='projCont-date'>" + date + "</p>" + "</div>" + "</div>" + "<div class='projCont-right'>" + "<div class='projCont-descript'>" + "<p class='projCont-intro'>" + title + "</p>" + "<div class='projCont-links'>" + ElLinks + "</div>" + "<p class='projCont-details'>" + more + "</p>" + "</div>" + "</div>" + "</div>" + "</div>");
    ...
    function initProj(section) {
        ...
        untilTablet = window.innerWidth < 750, $('#' + section).append(elProj);
...
var chatApp = function () {
    ...
    id,
        // string - it's build with string.slugLower -> ex : 'rede-expressos'
    ...
    function clickOption($option) {
        ...
        section = $option.closest('.chatSection').attr('id'), $currentPart = $option.closest('.chatPart'), btnName = $option.text(), title = $option.attr('name'), id = title.slugLower();
...
$(function cvProjects() {
    ...
    var cvProjects = function () {
        ...
        $sub = $('.js-cvProjSub');
        ArrProj = $cvProjects.toArray(), maxChild = ArrProj.length, projI = 0, keepLooping = true, $child = ''; //var on hightlightProject();
...
var OnWeb = function () {
    ...
    var $onWebLink,
        baffleWebSite,
        baffleWebDd,
        elOnWeb = $("<div class='onWeb cv-dl'>" + "<div class='onWeb-site'>" + "<span class='cv-dt js-onWeb-site'>my social networks</span>" + "</div>" + "<div class='onWeb-href'>" + "<a href='//codepen.io/sandrina-p' target='_blank' title='sandrina's stackoverflow' class='js-onWeb-link' data-site='codepen' data-dd='because coding without fun, it&#39;s just boring'>" + "<i class='fa fa-codepen'></i>" + "</a>" + "<a href='//github.com/sandrina-p' target='_blank' title='sandrina's stackoverflow' class='js-onWeb-link' data-site='github' data-dd='Sharing it&#39;s what make us better'>" + "<i class='fa fa-github'></i>" + "</a>" + "<a href='//stackoverflow.com/story/sandrina' target='_blank' title='sandrina's stackoverflow' class='js-onWeb-link' data-site='stackoverflow' data-dd='helping others is as important as being helped'>" + "<i class='fa fa-stack-overflow'></i>" + "</a>" + "<a href='//www.behance.net/sandrin4p' target='_blank' title='sandrina's stackoverflow' class='js-onWeb-link' data-site='behance' data-dd='it can&#39;t be all about code'>" + "<i class='fa fa-behance'></i>" + "</a>" + "</div>" + "<div class='onWeb-desc'>" + "<span class='cv-dd js-onWeb-dd'>not a big fan of facebook</span>" + "</div>" + "</div>");
