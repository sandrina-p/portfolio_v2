...
var TalkChat = function () {
    ...
    var conversation = {
        ...
        theory: {
            ...
            "other techs": "<strong>PHP</strong>, <strong>Angular 2</strong> and <strong>Ionic</strong> 2 have crossed her path, but right now she is focusing on improving her javascript skills. Soon she will start learning <strong>React</strong>, <strong>Firebase</strong> and <strong>Regular Expressions</strong>",
        ...
        practice: {
            intro: "On most of them she did both design and code parts. What connects them is the constant searching for <strong>something unique and interactive</strong>." + brk + "Lets start with something cool:",
...
var ChatNav = function () {
    ...
    $(function navInit() {
        ...
        function navTranslate() {
            var thisId = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
...
var Hashs = function () {
    ...
    if (hash) {
        $(function onDomReady() {
            ...
            }, 3000); // ~ time needed on css to show all header
        });
    }
