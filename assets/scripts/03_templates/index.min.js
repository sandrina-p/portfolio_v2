...
var Projects = function () {
    ...
    function buildProj() {
        ...
        + "<p class='projCont-details'>" + more + "</p>" + "</div>" + "<span class='projCont-descript-fadeOut'></span>" + "<div class='projCont-links'>" + ElLinks + "</div>" + "</div>" + "</div>" + "<div class='bot-nav'>press <span>[<]</span> and <span>[>]</span> to navigate through the projects</div>" + "</div>");
