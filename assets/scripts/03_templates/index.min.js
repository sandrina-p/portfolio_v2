...
var chatApp = function () {
    ...
    function animateClickedOption($option) {
        ...
        if ($siblings.length > 0) {
            ...
            //is is the last one, remove the parent.
            $parent.slideUp();
            $liIndex.slideUp();
            setTimeout(function () {
                $parent.remove();
