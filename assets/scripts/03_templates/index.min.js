...
(function (e, t, n) {
    ...
    (function (e, t, n, r) {
        ...
        var r = { touch: "ontouchend" in n };e.mobile.support = e.mobile.support || {}, e.extend(e.support, r), e.extend(e.mobile.support, r);
    }(e), function (e, t, r) {
        function l(t, n, i, s) {
            var o = i.type;i.type = n, s ? e.event.trigger(i, r, t) : e.event.dispatch.call(t, i), i.type = o;
        }var i = e(n),
            s = e.mobile.support.touch,
            o = "touchmove scroll",
            u = s ? "touchstart" : "mousedown",
            a = s ? "touchend" : "mouseup",
            f = s ? "touchmove" : "mousemove";e.each("touchstart touchmove touchend tap taphold swipe swipeleft swiperight scrollstart scrollstop".split(" "), function (t, n) {
            e.fn[n] = function (e) {
                return e ? this.bind(n, e) : this.trigger(n);
            }, e.attrFn && (e.attrFn[n] = !0);
        }), e.event.special.scrollstart = { enabled: !0, setup: function setup() {
                function s(e, n) {
                    r = n, l(t, r ? "scrollstart" : "scrollstop", e);
                }var t = this,
                    n = e(t),
                    r,
                    i;n.bind(o, function (t) {
                    if (!e.event.special.scrollstart.enabled) return;r || s(t, !0), clearTimeout(i), i = setTimeout(function () {
                        s(t, !1);
                    }, 50);
                });
            }, teardown: function teardown() {
                e(this).unbind(o);
            } }, e.event.special.tap = { tapholdThreshold: 750, emitTapOnTaphold: !0, setup: function setup() {
                var t = this,
                    n = e(t),
                    r = !1;n.bind("vmousedown", function (s) {
                    function a() {
                        clearTimeout(u);
                    }function f() {
                        ...
                        u;n.bind("vmouseup", a).bind("vclick", c), i.bind("vmousecancel", f), u = setTimeout(function () {
                        e.event.special.tap.emitTapOnTaphold || (r = !0), l(t, "taphold", e.Event("taphold", { target: o }));
                    }, e.event.special.tap.tapholdThreshold);
                });
            }, teardown: function teardown() {
                e(this).unbind("vmousedown").unbind("vclick").unbind("vmouseup"), i.unbind("vmousecancel");
            } }, e.event.special.swipe = { scrollSupressionThreshold: 30, durationThreshold: 1e3, horizontalDistanceThreshold: 30, verticalDistanceThreshold: 30, getLocation: function getLocation(e) {
                var n = t.pageXOffset,
                    r = t.pageYOffset,
                    i = e.clientX,
                    s = e.clientY;if (e.pageY === 0 && Math.floor(s) > Math.floor(e.pageY) || e.pageX === 0 && Math.floor(i) > Math.floor(e.pageX)) i -= n, s -= r;else if (s < e.pageY - r || i < e.pageX - n) i = e.pageX - n, s = e.pageY - r;return { x: i, y: s };
            }, start: function start(t) {
                var n = t.originalEvent.touches ? t.originalEvent.touches[0] : t,
                    r = e.event.special.swipe.getLocation(n);return { time: new Date().getTime(), coords: [r.x, r.y], origin: e(t.target) };
            }, stop: function stop(t) {
                var n = t.originalEvent.touches ? t.originalEvent.touches[0] : t,
                    r = e.event.special.swipe.getLocation(n);return { time: new Date().getTime(), coords: [r.x, r.y] };
            }, handleSwipe: function handleSwipe(t, n, r, i) {
                if (n.time - t.time < e.event.special.swipe.durationThreshold && Math.abs(t.coords[0] - n.coords[0]) > e.event.special.swipe.horizontalDistanceThreshold && Math.abs(t.coords[1] - n.coords[1]) < e.event.special.swipe.verticalDistanceThreshold) {
                    var s = t.coords[0] > n.coords[0] ? "swipeleft" : "swiperight";return l(r, "swipe", e.Event("swipe", { target: i, swipestart: t, swipestop: n }), !0), l(r, s, e.Event(s, { target: i, swipestart: t, swipestop: n }), !0), !0;
                }return !1;
            }, eventInProgress: !1, setup: function setup() {
                var t,
                    n = this,
                    r = e(n),
                    s = {};t = e.data(this, "mobile-events"), t || (t = { length: 0 }, e.data(this, "mobile-events", t)), t.length++, t.swipe = s, s.start = function (t) {
                    if (e.event.special.swipe.eventInProgress) return;e.event.special.swipe.eventInProgress = !0;var r,
                        o = e.event.special.swipe.start(t),
                        u = t.target,
                        l = !1;s.move = function (t) {
                        if (!o || t.isDefaultPrevented()) return;r = e.event.special.swipe.stop(t), l || (l = e.event.special.swipe.handleSwipe(o, r, n, u), l && (e.event.special.swipe.eventInProgress = !1)), Math.abs(o.coords[0] - r.coords[0]) > e.event.special.swipe.scrollSupressionThreshold && t.preventDefault();
                    }, s.stop = function () {
                        l = !0, e.event.special.swipe.eventInProgress = !1, i.off(f, s.move), s.move = null;
                    }, i.on(f, s.move).one(a, s.stop);
                }, r.on(u, s.start);
            }, teardown: function teardown() {
                var t, n;t = e.data(this, "mobile-events"), t && (n = t.swipe, delete t.swipe, t.length--, t.length === 0 && e.removeData(this, "mobile-events")), n && (n.start && e(this).off(u, n.start), n.move && i.off(f, n.move), n.stop && i.off(a, n.stop));
            } }, e.each({ scrollstop: "scrollstart", taphold: "tap", swipeleft: "swipe.left", swiperight: "swipe.right" }, function (t, n) {
            e.event.special[t] = { setup: function setup() {
...
!function (e, n, t) {
    function r(e, n) {
        ...
        function f() {
            ...
            if (h = e[p], v = z.style[h], i(h, "-") && (h = a(h)), z.style[h] !== t) {
    ...
    var conversation = {
        ...
        practice: {
            ...
            'rede expressos': {
                ...
                img: ["assets/media/img/projects/rnex0.png", "assets/media/img/projects/rnex1.png", "assets/media/img/projects/rnex2.png", "assets/media/img/projects/rnexx.png"],
                ...
                date: "MMM'YY",
                links: [["//app.html", "check app prototype", "mobile"], ["//www.html", "check homepage", "desktop"]]
            },
            'N O X': {
                ...
                img: ["assets/media/img/projects/nox0.png", "assets/media/img/projects/nox1.png", "assets/media/img/projects/nox2.png", "assets/media/img/projects/nox3.png", "assets/media/img/projects/nox4.png", "assets/media/img/projects/noxx.png"],
                capt: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
                more: "Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id <span class='nowrap'>est laborum.</span>",
                date: "MMM'YY",
            ...
            'carolina machado': {
                ...
                img: ["assets/media/img/projects/cm0.png", "assets/media/img/projects/cm1.png", "assets/media/img/projects/cm2.png", "assets/media/img/projects/cm3.png", "assets/media/img/projects/cm4.png", "assets/media/img/projects/cmx.png"],
            ...
            'portfolio 15': {
                ...
                img: ["assets/media/img/projects/sp0.png", "assets/media/img/projects/sp1.png", "assets/media/img/projects/sp2.png", "assets/media/img/projects/sp3.png", "assets/media/img/projects/sp4.png"],
                capt: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
            ...
            'pistol shrimp': {
                ...
                role: "Creative and Programmer",
                img: ["assets/media/img/projects/ps0.png", "assets/media/img/projects/ps1.png", "assets/media/img/projects/ps2.png", "assets/media/img/projects/ps3.png"],
            ...
            'moon': {
                ...
                sub: "Movie website",
                role: "Creative and Programmer",
                img: ["assets/media/img/projects/moon0.png", "assets/media/img/projects/moon1.png", "assets/media/img/projects/moon2.png", "assets/media/img/projects/moon3.png", "assets/media/img/projects/moon4.png", "assets/media/img/projects/moonx.png"],
            ...
            'DET': {
                ...
                img: ["assets/media/img/projects/DET0.png", "assets/media/img/projects/DET1.png", "assets/media/img/projects/DET2.png", "assets/media/img/projects/DET3.png", "assets/media/img/projects/DETx.png"],
            ...
            '141205': {
                ...
                sub: "3D animation",
                role: "Creative and Programmer",
                img: ["assets/media/img/projects/blend0.png", "assets/media/img/projects/blend1.png", "assets/media/img/projects/blend2.png", "assets/media/img/projects/blend3.png", "assets/media/img/projects/blend4.png", "assets/media/img/projects/blendx.png"],
                capt: "Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.",
        ...
        behaviour: {
            ...
            psstChat: ["i'm surprised", "i'm not sure what to say but ... algo fun <span class='nowrap'>seria nice.</span>", "[do nothing]", "[go to bot]"],
...
var TalkBot = function () {
    ...
    function genLink(link, name, target) {
        typeof target == 'undefined' ? target = "target='_blank'" : target = "";
    ...
    var publicCmd = "Some stuff you can know about:" + brk + "<b>technologies</b>" + brk + "<b>best practices</<b>" + brk + "<b>challenges</b>" + brk + "<b>resources</b>" + brk + "<b>exit</b>" + brk + "<b>...</b>";

    var botOptHelp = "Maybe you should " + googleIt + " and then come back. What do you think?";

    var conversation = {
        intro: ["Now that we talked enough about Sandrina," + brk + "^100Ah yes, that's her name, I forgot to tell you. Anyways..." + brk + "^150I think I could talk about me. Like, nerd talk... but before that just tell me one thing:" + brk + "1 divided by 0 equal to:", "your answer here", "options"],
        options: {
            /* STRUCTURE:
            ...
            */
            "∞ infinity, infinity, infinito, ∞, universe, cosmos": ["You are a little crazy… we all are." + brk + "Despite always being under construction I already have the ability to share some stuff that Sandrina taught me while I was growing up." + publicCmd, "what's next?", "commands"],
            "undefined, null": ["Not it's not. It has another name. At least on javascript language.", "go ask it to some console", "options"],
            "1/0, 1 divided by 0, one divided by zero": ["◉_◉ Don't try to turn the game against me." + brk + "I'm a bot, not a console.", "go ask it to other console", "options"],
            "zero, 0": ["You know that Siri isn't always right." + brk + "^400Neither do you." + brk + "^800" + botOptHelp, 'I still believe in you', "options"],
            "exit, esc": ["Really? We didn't even start you already want to leave.. Press ESC and go get a life", "I still believe in you", "options"],
            "HELP, helpp, help, i don't know, dunno, i'm not sure, help me": ["I'm glad I can teach you something new!" + brk + "I'm build with javascript, so in my world 1/0 is <i>∞ infinity</i>." + brk + "In other worlds the answer can be <i>0</i> or <i>undefined</i>." + brk + "I'm a sensible machine so I like to think there is much more beyond nothing.", "so, now you know how much is 1/0!", "options"],
            "google it": [botOptHelp, "I still believe in you", "options"],
        ...
        commands: {
            "technologies": [["I was born inside the Atom editor." + brk + "HTML5, SCSS and Javascript are my vital organs.", "|", "commands"], ["I started being built with " + linkKoala + " but as any good programmer knows, crashes happen, so " + linkGulp + " took its place!", "|", "commands"], ["You might be talking only with me, but Sandrina knows everything you said and clicked. That's her way to improve me each time a new user comes here.", "|", "commands"], ["Unfortunately right now I'm just a static website with some php on index. But soon I'll be moved to " + linkFirebase + "." + brk + "Then you'll be able to talk directly with Sandrina right here without using mail or wtv you choose to use now.", "|", "commands"], ["You might think that javascript and jQuery are old fashion. But the truth is they are the base of all new fancy techs. React, Angular, Typescript, etc.." + brk + "Sandrina is making sure that she really <i>master</i> jQuery and JS before going further with those fancy techs.", "|", "commands"]],
            ...
            "resources, resources, resource": [["still under construction", "don't push me that way okay? :/", "commands"]],
            "challenges": [["Do you want to know the secret behind these cool animations?" + brk + "CSS makes the magic happen." + brk + "And the javascript only toggles them when it is necessary." + brk + "It makes things run much smoother." + brk + "And that’s really important because there is nothing worst than a laggy website.", "|", "commands"], ["Maybe you will not believe me, but that switching images effect on Sandrina's projects are CSS only." + brk + "You read me right:" + brk + "no javascript" + brk + "at all. Check it out on [codepen]." + brk + "As well as her [portrait]..." + brk + "You didn’t think that was an image, did you?" + brk + "" + portraitMsg, "|", "commands"], ["My purpose here, despite being a bot, is having a conversation with you." + brk + "I try to be funny, of course." + brk + "But I won’t say the same thing twice." + brk + "Or tell you stuff you didn't asked for." + brk + "What I’m trying to say is I am a bot with a passion for context and human interaction." + brk + "I pretend to think ... by taking some time to answer you, but the truth is, I already knew what to tell you before we first met. They say smart guys think. So I learned to make you think I was thinking so I could impress you [. . .]", "|", "commands"]],
            "keepSection": ["Press ENTER again to know more about [*param*]", ["technologies", "best practices", "challenges"]],
            "allSaid": [["I don't have anything else to tell you about [*param*] " + brk + publicCmd, "|", "commands"], ["best practices", "challenges"]]
        },
        bored: {
        ...
        vocabulary: {
            ...
            "what's your name?, what is your name?": ["I'm 008080. What about you?", "you can tell me, but i'll not be able to understand you. not yet :(", "username"],

            "008080, #008080": ["Yap! That's my name! Why? Sandrina likes Teal as you can see, yh... a basic straight answer."],
            "...": ["there are more commands available than you think. In fact, you can " + linkHelpMe + " to better understand your human kind."],
            "esc, restart, reset, clear": ["are you sure about that? all our memories - at least mine - will be erased. If so, press ESC twice."],
            "ok, okay": ["hmm... ok."],
            "SUIT, SUIT methodology, Module Pattern, Gulp, Grunt, perceived loading time, FOUC": ["hmm... I knew you would type that. Sandrina already did some user research, like you in this moment. Soon I'll be able to better answer you, but for now, it's better for you to [Google It].", "this time do it by youself, yes? :D"],
            "tell me more, more, what else?, what else": ["you are such a curious creature :3. I'm still under construction, but you can leave a quick message to Sandrina. Just type something started by @@. She will answer you for sure.", //TODO
            "@@ your@email.com - Hi sandrina! How much is 0.1 + 0.3 ?"],

            "tilttt": ["something went wrong and i think I just crashed... please can you try again?", //TODO
            "@@ your@email.com - Hi sandrina! How much is 0.1 + 0.3 ?"],
            "help, help me, lost, i'm lost": ["We all get lost sometimes" + brk + "" + publicCmd, "try again"],
            "bye, cya, shut down, exit, halt, close": ["You know what... It's really hard having a human conversation." + brk + "That's why I'm just a bot." + brk + "<i>008080</i> by the way." + brk + "Nice to meet you :) It was nice to talk to you, thank you!" + brk + "But now do me a favor and go get a life, yes?" + brk + "It’s not healthy to talk to a bot all day." + brk + "By the way, don't forget to share me and talk about Sandrina while you’re out there :3", "press x to close"]
        },
        ...
        EmpTy: [['._.', "don't be shy"], ['" "', "i'm feeling you"], ['?', "silence is good"], ['...', "oh well"], ["(ง'̀-'́)ง", "hi?"], ['◉_◉', "bored", "are you bored?"]]
    };
...
var TalkBotVocabulary = function (currentTalkBot) {
    ...
    */
    knowIt["yo, yoyo"] = ["MC 008080 in da house yall!" + brk + "Sandrina isn't really a major Hip Hop fan, but I am." + brk + "You wanna dig my rhymes? type <b>mc 008080</b>", "_"];
    knowIt["mc 008080"] = ["Sandrina is the pro who'll get things done" + brk + "From styling to dev, she'll beat you son!" + brk + "She's the browser magician," + brk + "Her skillz: an addiction" + brk + "You know she's the boss" + brk + "Cause you found this musician" + brk + "....peace!", "_"];
    knowIt["yes, cool, yeah, yeas, wow, that is cool, that's cool"] = ["Indeed! Try other commands like:" + brk + "<b>best practices</b>" + brk + "<b>challenges</b>" + brk + "<b>resources</b>" + brk + "<b>nestum addiction</b>", "_"];
    knowIt["damn"] = ["Yeah! (•_•) / ( •_•)>⌐■-■ / (⌐■_■)" + brk + "AHHHHHHHHHHHHHHHHHH!!!!!! TUM TUMTUM.", "_"];
    knowIt["you suck, cause you suck"] = ["You're not being very nice :(" + brk + "Maybe a <b>joke</b> will cheer you up!", "_"];
    knowIt["joke, tell me a joke, tell joke"] = ["What’s Beethoven’s favorite fruit?" + brk + "<^200.^200.^200." + brk + "^200..^200..^200.." + brk + "^300...BA-NA-NAA-NAAAAAA!", "_"];
    knowIt["lol, lolol, ahah"] = ["I'm a funny bot ;)" + brk + "It all has to do with my personality.", "_"];
    knowIt["sorry, i'm sorry, i am sorry"] = ["Don't worry, I'm a bot. I have no feelings ;)", "_"];
    knowIt["mm"] = ["Meamu.", "commands", ""];
    knowIt["birthday, when's your birthday, your birthday, when is your birthday, birth date, your birth date"] = ["I was created somewhere between July and October 2016, and oficially released on November 2016", "_"];
    knowIt["personality"] = ["Clearly, I'm an ENTP, since I'm so good talking to people! Sandrina is an <b>INTJ</b> though, so, we're very unlike each other", "_"];
    knowIt["intj"] = ["Well, you know how INTJ's are." + brk + "They are very focused, always trying to be the best at what they love so dearly, their work. Also, they have the rare quality of being very tidy and organized people.", "_"];
    knowIt["nestum addiction, nestum"] = ["omg. .... omg omg omg" + brk + "DID YOU JUST SAY NESTUM" + brk + "I don't know love, and I don't think I have felt it, except for when someone says Nestum." + brk + "I think about Nestum all day. I have dreams about Nestum..." + brk + "Nestum is my life!!!", "_"];
...
var Projects = function () {
    ...
    function addProjNav(quantity) {
        var addProjects = "",
            nameSlug,
            projI = isParentLeft ? arrProjects.indexOf($projLeft.children(":first").text()) : arrProjects.indexOf($projRight.children(":last").text());

        if (isParentLeft) {
            for (var i = 1; i <= quantity; i++) {
                projName = arrProjects[projI - i] || arrProjects[arrProjects.length - 1];
                nameSlug = projName.split(' ').join('-').toLowerCase(), addProjects += "<button type='button' name='" + nameSlug + "' class='projNav-btn' data-gaec='projects'>" + projName + "</button>"; //TODO merge duplicated syntax
            }
    ...
    function getProjDomElements() {
        ...
        $projSub = $(classProjSub), $projMedia = $(classProjMedia), $projRole = $(classProjRole), $projDate = $(classProjDate), $projIntro = $(classProjIntro), $projDetails = $(classProjDetails), $projLinks = $(classProjLinks), $projBotTip = $(classProjBotTip), $pivot = $('.projNav-pivot'), $projLeft = $('.projNav-left'), //In case you, sandrina, forget it, it's needed -left and -right to smooth things out when a new button cames out
    ...
    function updateVarsOnNav(condition) {
        if (condition) {
            $projDir = $projLeft, fPos = 'last';
        } else {
            $projDir = $projRight, fPos = 'first';
        }
    ...
    function alignPivot($newProject) {
        ...
        transX = untilTablet ? 16 + pivotX - projActiveX : windowBotWidth + pivotX - projActiveX - projActiveWidth; //i think i'm overcomplicating.
    ...
    function showNewProject() {
        ...
        if (addProjNumb > 0) {
            ...
            isParentLeft ? $projLeft.children().first().remove() : $projRight.children().last().remove();
        }
    ...
    function baffleProj() {
        ...
        baffleSub = baffle(arrBuffle[0]), baffleIntro = baffle(arrBuffle[1]), baffleRole = baffle(arrBuffle[2]), baffleDate = baffle(arrBuffle[3]), baffleDet = baffle(arrBuffle[4]);
    ...
    function startIt(section) {
        var elProj = buildProj(),
            ...
            //FIXME strange bug with safari isn't always right
        untilTablet = window.innerWidth < 750,
            i = UtilFuncs.randomNumb(arrProjects.length - 1) + 1,
            //between 1 and arrProjects.length
        projName = arrProjects[i];
    ...
    function onNavProjClick($btn) {
        ...
        if (numbOfGestures == 0) {
            Modernizr.touchevents ? changeBotNavText(chatContent.behaviour.navProjMob) : changeBotNavText(chatContent.behaviour.navProjDesk);
        }
...
var chatNav = function () {
    ...
    $(function navInit() {
        ...
        baffleBg.start().text(function (currentText) {
            return mainSections[0];
        });

        baffleTh.start().text(function (currentText) {
            return mainSections[1];
        });

        bafflePr.start().text(function (currentText) {
            return mainSections[2];
        });

        (function showNav() {
            if ($heyThereIntro.css('opacity') > "0.9") {
                //wtf iphone6, why the fuck you return 0.9999989867210388 on console.
...
var chatApp = function () {
    ...
    function clickOption($option) {
        ...
        section = $option.closest('.chatSection').attr('id'), $currentPart = $option.closest('.chatPart'), btnName = $option.text(), title = $option.attr('name'), id = UtilFuncs.stringSlugLower(title);
    ...
    function animateClickedOptionMob($option, $part) {
        ...
        thisTop = $parent.offset().top, thisLeft = $parent.offset().left, $newTitle = $part.find(chatPClass + "title"), otherTop = $newTitle.offset().top, otherLeft = $newTitle.offset().left, thisX = otherLeft - thisLeft, thisY = otherTop - thisTop;
    ...
    function getElPart() {
        return $("<div class='chatPart' id='" + id + "'>" + "<div class='chatPart-human'>" + "<p class='chatPart-title jsLoading'>" + title + "</p>" + "</div>" + "<div class='chatPart-bot'>" + "<p class='chatPart-text jsLoading'>" + text + "</p>"
        // options
        + "</div>" + "</div>");
    }
    ...
    function scrollSafe($currentPart) {
        if (!untilTablet) {
            var wScroll = $(window).scrollTop(),
                wHeight = window.innerHeight;
            pHeight = $currentPart.height(), pScroll = $currentPart.offset().top, tooClose = pScroll - wScroll + pHeight > wHeight / 2;
    ...
    function buildSection() {
        ...
        var ElChatPart = $("<div class='chatPart-bot'>" + "<p class='chatPart-text jsLoading'>" + text + "</p>" + "</div>");
    ...
    $(function ifTouchScreen() {
        if (hasTouch) {
            var $jsPsst = $('.js-psst'),
                ...
                innerHeight,
                newMargin = 400,
                scrolledRecord = !isNaN(localStorage.getItem("scrolledRecord")) ? localStorage.getItem("scrolledRecord") : 1;
...
var botSection = function () {
    ...
    function showInput() {
        ...
        var name = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "vocabulary";


        $('#' + botInputId).attr({ name: name, placeholder: placeholder }).removeClass('jsLoading').focus();
