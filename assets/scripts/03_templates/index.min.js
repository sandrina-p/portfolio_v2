...
var TalkBot = function () {
    ...
    var conversation = {
        intro: ["Now that we talked enough about Sandrina," + brk + "^100Ah yes, that's her name, I forgot to tell you. Anyways..." + brk + "^150I think I could talk about me. Like, nerd talk... but before that just tell me one thing:" + brk + "1 divided by 0 equal to:", "options", "your answer here", "typedJS"],
        options: {
            /* STRUCTURE:
            ...
            */
            "go, infinity, infinito, ∞, universe, cosmos": ["You are a little crazy… we all are." + brk + "Despite always being under construction I already have the ability to share some stuff that Sandrina taught me while I was growing up." + publicCmd, "commands", "what's next?", "typedJS"],
            ...
            "zero, 0": ["You know that Siri isn't always right." + brk + "^1000Neither do you.^500" + brk + botOptHelp, "options", 'I still believe in you', "typedJS"],
        ...
        commands: {
            ...
            "resources, resources, resource": [["still under construction", "commands", "don't push me that way okay? :/"]],
        ...
        "help, help me, lost, i'm lost": ["We all get lost sometimes" + brk + "" + publicCmd, "[*params*]", "try again"],
        vocabulary: {
            ...
            "what's your name?, what is your name?": ["I'm 008080. What about you?", "username", "you can tell me, but i'll not be able to understand you. not yet :("],
            ...
            "...": ["there are more commands available than you think. In fact, you can " + linkHelpMe + " to better understand your human kind.", "commands", "", "typedJS"],
            ...
            "SUIT, SUIT methodology, Module Pattern, Gulp, Grunt, perceived loading time, FOUC": ["hmm... I knew you would type that. Sandrina already did some user research, like you in this moment. Soon I'll be able to better answer you, but for now, it's better for you to [Google It].", "commands", "this time do it by youself, yes? :D"]
        },
        ...
        EmpTy: [['._.', "commands", "don't be shy"], ['" "', "commands", "i'm feeling you"], ['?', "commands", "silence is good"], ['...', "commands", "oh well"], ["(ง'̀-'́)ง", "commands", "hi?"], ['◉_◉', "bored", "are you bored?"]]
    };
    ...
    function addProjNav(quantity) {
        ...
        if (isParentLeft) {
            for (var i = 1; i <= quantity; i++) {
                ...
                nameSlug = projName.split(' ').join('-').toLowerCase(), addProjects += "<button type='button' name='" + nameSlug + "' class='projNav-btn'>" + projName + "</button>";
            }
...
var chatApp = function () {
    ...
    function getElBtn(text) {
        return "<div class='chatPart-option jsLoading'>" + "<button type='button' name='" + text + "' class='btnB jsLoading js-chatOpt'>" + text + "</button>" + "</div>";
    }
