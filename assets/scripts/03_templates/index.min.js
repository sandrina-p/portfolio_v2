...
var TalkBot = function () {
    ...
    var conversation = {
        ...
        intro: ["Now that we talked enough about Sandrina," + brk + "^100Ah yes, that's her name, I forgot to tell you..." + brk + "^150 Now we can talk about me. How I was made and what Sandrina has to share! But before that just tell me one thing:" + brk + "1 divided by 0 equal to:", "your answer here", "options"],
        options: {
            /* STRUCTURE:
            ...
            */
            ...
            "infinito, infinite, infiniti, infinyti, infiniti,": ["I think you meant <i>infinity</i>... Well let's start:", +brk + "Despite always being under construction I already have the ability to share some knowledge Sandrina taught me while I was growing up." + brk + "" + publicCmd, "what's next?", "commands"],
            "undefined, null, error": ["Not it's not. It has another name. At least on javascript language.", "go ask it to some console", "options"],
            ...
            "zero, 0": ["You know that Siri isn't always right." + brk + "^400Neither do you." + brk + "^600" + botOptHelp, 'I still believe in you', "options"],
            ...
            "skip, skip this shit": ["Okay then, so these are some of the things i can share with you:" + brk + "" + publicCmd, "what's next?", "commands"],
