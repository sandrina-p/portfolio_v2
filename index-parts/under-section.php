            ...
            <article class="cv-article">
                <div class="cv-article-in">
                    ...
                    <dl class="cv-dl js-onWebAfter">
                        ...
                        <dd class="cv-dd js-onWeb-remove">because coding without fun, it's just boring</dd>
                        ...
                        <dd class="cv-dd js-onWeb-remove">sharing is what make us better</dd>
                        ...
                        <dd class="cv-dd js-onWeb-remove">helping others is as important as being helped</dd>
                        ...
                        <dd class="cv-dd js-onWeb-remove">it can't be all about coding</dd>
                    </dl>
                    <!-- don't kill me, but those fancy hover links are loaded by javascript too -->
                </div>
            </article>
            ...
            <article class="cv-article">
                <div class="cv-article-in">
                    ...
                    <ul class="cv-ul">
                        ...
                        <li class="cv-li cv-li--br">Adobe Family <span class="nowrap">[ps id ai ae]</span></li>
                        <li class="cv-li">Sketch</li>
