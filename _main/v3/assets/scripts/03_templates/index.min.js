...
var botContent = {
    ...
    bests: ["When I first said hello, I wasn't totally ready for you - guess that makes me a bit human, right? But while you were reading my first sentence I had enough time to send you the rest of the CSS and JS files that I needed to have a conversation with you. That's a great way to reduce [perceived loading time] and avoid [FOUC], don't you think?", "I started following [SUIT methodology] (css) and [Module Pattern] (js). Which basically means it is very easy for me to adapt myself and change my appearance when Sandrina gets new crazy ideas during her boredom strikes. I mean, what will a coder do when she is bored other than code some more?", "I know you have a sweet " + browser + " with javascript, but I am a wise bot so I always take into consideration people without javascript or with a shitty browser. Of course they don’t get the chance to talk to some cool AI like myself, but at least they will know enough about Sandrina. And in a not creepy way - I was designed like that, it’s not like I worship her -, that’s my life’s purpose: to talk about her, despite the outdated technology people use to access me.", resolutionScreenMsg],
    challenges: ["Do you want to know the secret behind these cool animations? CSS makes the magic happen. And the javascript only toggles them when it is necessary. It makes things run much smoother. And that’s really important because there is nothing worst than a laggy website.", "Maybe you will not believe me, but that switching images effect on Sandrina's projects are CSS only. You read me right: no javascript at all. Check it out on [codepen]. As well as her [portrait]... You didn’t think that was an image, did you? /*if (scroll.top < window.innerHeight) */oh wait.. you didn't see her portrait yet! clicking isn't everything, you know...*", "My purpose here, despite being a bot, is having a conversation with you. I try to be funny, of course. But I won’t say the same thing twice. Or tell you stuff you didn't asked for. What I’m trying to say is I am a bot with a passion for context and human interaction. I pretend to think [ . . . ] by taking some time to answer you, but the truth is, I already knew what to tell you before we first met. They say smart guys think. So I learned to make you think I was thinking so I could impress you [ . . . ]"],
...
var chatApp = function () {
    ...
    id,
        // string - it's build with getPartIdName() -> ex : 'rede-expressos'
    ...
    function getProjectsIndex(section) {
        ...
        for (var key in objSection) {
            if (objSection.hasOwnProperty(key)) {
                ...
                var li = "<li class='liIndex-liProj'>" + "<button type='button' name='button' class='btnB js-chatOpt'>" + key + "</button>" + "<span class='liIndex-sub'>" + objSection[key]['sub'] + "</span>" + "</li>";
