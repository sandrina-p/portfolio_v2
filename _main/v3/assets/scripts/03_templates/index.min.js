...
var chatApp = function () {
    ...
    function getElPart(id, title, text) {
        ...
        var chatPart = $("<div class='chatPart chatPart--jsLast' id='" + id + "'>" + "<div class='chatPart-human'>" + "<p class='chatPart-title jsLoading'>" + title + "</p>" + "</div>" + "<div class='chatPart-bot'>" + "<p class='chatPart-text jsLoading'>" + text + "</p>"
        // options FIXME
        + "</div>" + "</div>");
    ...
    function getElProject(id, title, sub, img, role, capt, more, links) {
        ...
        var chatProj = $("<div class='chatPart chatPart--project chatPart--jsLast' id='" + id + "'>" + "<div class='chatPart-human'>" + "<h3 class='chatPart-title'>" + title + "</h3>" + "<h4 class='chatPart-subtitle'>" + sub + "</h4>" + "</div>" + "<div class='chatPart-bot'>" + "<div class='chatPart-project'>"
    ...
    function buildIndexPart($section) {
        ...
        ElChatPart.find(botClass).append('<div class="ifCondition">' + '<button type="button" name="button" class="btnB js-practiceIndex">' + chatContent.practice.clickMsg + '</button>' + '<span class="chat-Part">' + chatContent.practice.scrollMsg + '</span>' + '</div>');
