...
linkKoala = genLink('//koala-app.com/', 'Koala'), linkGulp = genLink('http://gulpjs.com/', 'Gulp'), linkSUIT = genLink('#linkTODO', 'SUIT methodology'), linkMP = genLink('#TlinkODO', 'Module Pattern'), linkLT = genLink('#TlinkODO', 'perceived loading time'), linkFOUC = genLink('#linkTODO', 'FOUC'), linkGit = genLink('#linkTODO', 'Bitbucket'), myEmail = genLink('mailto:sandrin4pereir4@gmail.com?subject=Hey%20there!', 'sandrin4pereir4@gmail.com');

var botTextAbout = "I was born inside the Atom editor." + brk + "^100 HTML5, SCSS and Javascript are my vital organs." + brk + "^500 Eventually I evolved and started being built with " + linkKoala + " but as any good programmer knows, crashes happen, so " + linkGulp + " took its place!" + brk + "^250 Despite always being under construction I already have the ability to share some stuff that Sandrina taught me while I was growing up." + publicCmd;

var publicCmd = "What you can know about me:" + brk + "best practices" + brk + "challenges" + brk + "resources" + brk + "exit" + brk + "...";
    ...
    function getBotAnswer() {
        ...
        switch (context) {
            ...
            case 'commands':
                ...
                botAnswer == undefined || botAnswer.length == 0 ? searchVocabulary() : appendBotAnswer(botAnswer, objContext);
                break;
