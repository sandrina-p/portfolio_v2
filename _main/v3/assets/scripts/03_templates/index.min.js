...
var botSection = function () {
    ...
    triggerActive = 'jsLoading', $bot = $('#bot'), $botText = $bot.find('.bot-text'), clickOn = {}, firstTrigger = true;
