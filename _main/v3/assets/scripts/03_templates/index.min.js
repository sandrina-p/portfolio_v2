...
var Projects = function () {
    ...
    $pivot = $('.projNav-pivot'), $projLeft = $('.projNav-left'), $projRight = $('.projNav-right'), $projActive = $('button.' + activeClass);
    ...
    function alignPivot($newProject) {
        ...
        pivotX = $pivot.offset().left, projActiveX = $newProject.offset().left, projActiveWidth = $newProject.outerWidth(), transX = windowBotWidth + pivotX - projActiveX - projActiveWidth;
...
var chatApp = function () {
    ...
    function listenScrollProject() {
        setTimeout(function () {
            $lastProj = $('#practice').children(":nth-last-of-type(2)"), listenNewProject = true, pHeight = $lastProj.height(), pScroll = $lastProj.offset().top;
        }, 250);
    }
