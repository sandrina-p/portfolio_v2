...
var Projects = function () {
    ...
    function getElProj() {
        ...
        ElProj = $("<div class='proj' id='projects'>" + "<div class='projNav'>" + "<div class='projNav-pivot'>" + "<div class='projNav-left'>" + elProjNav + "</div>" + "<div class='projNav-right'>" + elProjNav + "</div>" + "</div>" + "</div>" + "<div class='projCont'>" + "<div class='projCont-left'>" + "<p class='projCont-subtitle'>" + sub + "</p>" + "<div class='projCont-media'>" + "<div class='Glidder'>" + elImgs + "</div>" + "</div>" + "<div class='projCont-about'>" + "<p class='projCont-role'>" + role + "</p>" + "<p class='projCont-date'>" + date + "</p>" + "</div>" + "</div>" + "<div class='projCont-right'>" + "<span class='projCont-descript-fadeIn'></span>" + "<div class='projCont-descript'>" + "<p class='projCont-intro'>" + title + "</p>" + "<input type='checkbox' id='toggleDetails'/>" + "<label for='toggleDetails' class='btnMore'>_more info</label>" + "<p class='projCont-details'>" + more + "</p>" + "</div>" + "<span class='projCont-descript-fadeOut'></span>" + "<div class='projCont-links'>" + ElLinks + "</div>" + "</div>" + "</div>" + "<div class='bot-nav'>press [<] and [>] to navigate through the projects</div>" + "</div>");
    ...
    function getProjectData(projName) {
        projSlug = projName.split(' ').join('-').toLowerCase(), projData = chatContent.practice[projName], elImgs = getProjectImgs(projData.img), elLinks = getProjectLinks(projData.links);
...
var chatApp = function () {
    ...
    id,
        // string - it's build with stringToSlug() -> ex : 'rede-expressos'
    ...
    intervalLoadingDots,
        //function - setInteral controller

    //some conditions that practice has //REVIEW review this. is too complex.
    initProj,
        //string - used when calls a project without starting the chat.
    isIntroPractice,
        //bollean - if 1st project, show index
    ...
    function init(option) {
        ...
        if (mainSections.indexOf(title) < 0) {
            ...
            section == "practice" && title != "practice" ? buildProject(section, title) : buildSentence(section, title);
        } else {
            buildSection(title);
        }
    }
    ...
    function outsider(trigger) {
        section = trigger.data('section'), title = trigger.data('title');
        ...
        $("#" + id).length > 0 ? bodyScrollTop($("#" + id).offset().top - wHeight / 4 * 1) : buildSection(section);
    }
    ...
    function getElBtn(text) {
        var chatBtn = "<div class='chatPart-option'>" + "<button type='button' name='button' class='btnB jsLoading js-chatOpt'>" + text + "</button>" + "</div>";
        return chatBtn;
    }
    ...
    function getElPart(id, title, text) {
        ...
        //chatPart--jsLast
        var chatPart = $("<div class='chatPart' id='" + id + "'>" + "<div class='chatPart-human'>" + "<p class='chatPart-title jsLoading'>" + title + "</p>" + "</div>" + "<div class='chatPart-bot'>" + "<p class='chatPart-text jsLoading'>" + text + "</p>"
        // options FIXME
        + "</div>" + "</div>");
    ...
    function getElProject(id, title, sub, img, role, capt, more, links) {
        ...
        var chatProj = $("<div class='chatPart chatPart--project' id='" + id + "'>" + "<div class='chatPart-human'>" + "<h3 class='chatPart-title'>" + title + "</h3>" + "<h4 class='chatPart-subtitle'>" + sub + "</h4>" + "</div>" + "<div class='chatPart-bot'>" + "<div class='chatPart-project'>"
        // TODO Glidder glitch + slider
        + "<div class='chatPart-fs'>" + elImgs + "</div>" + "<h5 class='chatPart-role'>" + role + "</h5>" + "<p class='chatPart-capt'>" + capt + "</p>" + "<p class='chatPart-more jsLoading'>" + more + "</p>" + "<div class='chatPart-details'>" + "<button type='button' name='more' class='btnDetails'>_more info</button>" + "<div class='chatPart-www'>" + "<span class='chatPart-checkItOut js-checkItOut'></span>" + ElLinks + "</div>" + "</div>" + "</div>" + "</div>" + "</div>");
        ...
        for (var key in objSection) {
            if (objSection.hasOwnProperty(key)) {
                ...
                if ($liIndexUl.find('.' + catC).length == 0) {
                    var newCat = "<li class='liIndex-liCateg " + catC + "'>" + "<span class='liIndex-categ'>" + categ + "</span>" + "<ul class='liIndex-dl'></ul>" + "</li>";
                    $liIndexUl.append(newCat);
                }

                var li = "<li class='liIndex-liProj'>" + "<button type='button' name='button' class='btnP js-chatOpt'>" + key + "</button>" + "<span class='liIndex-sub'>" + objSection[key]['sub'] + "</span>" + "</li>";
    ...
    function getProjectLinks(links) {
        var elLinks = "";
        for (i = 0; i < links.length; i++) {
            links[i][1] == "available soon" ? elLinks += "<i title='" + links[i][1] + " class='fa fa-" + links[i][2] + "'></i>" : elLinks += "<a href='" + links[i][0] + "' target='_blank' class='btnOut" + [i + 1] + " js-linkswww' title='" + links[i][1] + "'><i class='fa fa-" + links[i][2] + "'></i></a>";
        }
        return elLinks;
    }
    ...
    function buildIndexPart($section) {
        ...
        ElChatPart.find(botClass).append('<div class="ifCondition">' + '<button type="button" name="button" class="btnB js-practiceIndex">' + chatContent.behaviour.clickMsg + '</button>' + '<span class="chat-Part">' + chatContent.behaviour.scrollMsg + '</span>' + '</div>');
