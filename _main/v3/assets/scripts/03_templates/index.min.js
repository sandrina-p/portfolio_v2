...
var chatApp = function () {
    ...
    function outsider(trigger) {
        section = trigger.data('section'), title = trigger.data('title'), initProj = trigger.data('initproject');
        ...
        $("#" + id).length > 0 ? bodyScrollTop($("#" + id).offset().top - wHeight / 4 * 1) : buildSection();
    }
    ...
    function getElBtn(text) {
        return "<div class='chatPart-option'>" + "<button type='button' name='button' class='btnB jsLoading js-chatOpt'>" + text + "</button>" + "</div>";
    }
